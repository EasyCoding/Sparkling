...
function sparkling_scripts() {
  ...
  // Add Google Fonts
  wp_register_style( 'sparkling-fonts', '//fonts.googleapis.com/css?family=Open+Sans:400italic,400,600,700|Roboto+Slab:400,300,700&subset=cyrillic,latin');
  ...
  wp_enqueue_script('jquery-updated', get_template_directory_uri() . '/inc/js/functions.min.js', array('jquery') );
